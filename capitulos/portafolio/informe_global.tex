...
\begin{recomendacion}[title={Recomendación 1: Ecosistema de datos de talento «Talent Intelligence»}]
...
\begin{recomendacion}[title={Recomendación 2: \textit{Journey} del empleado integrado: de la socialización al desarrollo}]
...
\begin{recomendacion}[title={Recomendación 3: Cierre del ciclo de vida — \textit{Outplacement} estructural y gestión de la salida}]
...
\begin{recomendacion}[title={Recomendación 4: Humanización de la evaluación del rendimiento mediante el modelo 360° y la desvinculación del \textit{ranking}}]
...
\begin{recomendacion}[title={Recomendación 5: \textit{Reskilling} masivo como política de planificación preventiva}]
...
\begin{recomendacion}[title={Recomendación 6: Integración de la estrategia ASG en el ciclo completo de RRHH}]
